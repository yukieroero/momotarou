...
namespace Timeline {
    ...
    public class Narrator {
        ...
        public Narrator() {
            ...
            Text text = narration.AddComponent<Text>();
        ...
        public void set(string text) {
            this.Narration.GetComponent<Text>().text = text;
            this.GameObject.SetActive(true);
            TimelineHelper.setRectPosition(this.Narration.GetComponent<RectTransform>(), 0, 0, 0, 0);
            TimelineHelper.setRectPosition(this.RectTransform, 0, 0, 0, 0);
            this.RectTransform.localScale = Vector3.one;
        }
        public void hide() {
            this.GameObject.SetActive(false);
            this.Narration.GetComponent<Text>().text = "";
        }
    }
