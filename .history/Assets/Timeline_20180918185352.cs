...
namespace Timeline {
    ...
    public class Narrator {
        ...
        public Narrator() {
            ...
            narration.AddComponent<Image>().color = new Color(0, 0, 0, 140);
            GameObject narrationText = new GameObject();
            narrationText.name = "Text";
            this.Text = narrationText.AddComponent<Text>();
            this.Text.alignment = TextAnchor.MiddleCenter;
            TimelineHelper.setTextStyle(this.Text, 30, Color.white, Resources.Load<Font>("fonts/hiragino"));
            narrationText.transform.SetParent(narration.transform);
            TimelineHelper.setRectPosition(narrationText.GetComponent<RectTransform>(), 0, 0, 0, 0);
        ...
        public void set(string text) {
            ...
            TimelineHelper.setRectPosition(this.Text, 0, 0, 0, 0);
