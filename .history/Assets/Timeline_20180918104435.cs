...
namespace Timeline {
    ...
    public class Balloon : AbsCommand {
        ...
        public Balloon (string serif, string position) {
            ...
            // RectTransform balloonUITrans = balloonUI.AddComponent<RectTransform>();
            // balloonUITrans.anchorMin = new Vector2(0f, 0f);
            // balloonUITrans.anchorMax = new Vector2(1f, 1f);
            // balloonUITrans.anchoredPosition = new Vector2(0.5f, 0.5f);
