...
public class KamishibaiController : MonoBehaviour {
    ...
    public void action(Person actor, string serif, string position) {
        ...
        RectTransform balloonUIRect = balloon.GameObject.transform.FindChild("balloonUI").GetComponent<RectTransform>();
        float maxWidth = 400f;
        if (balloonUIRect.sizeDelta.x > maxWidth) balloonUIRect.sizeDelta = new Vector2(maxWidth, balloonUIRect.sizeDelta.y);
