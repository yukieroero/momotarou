...
public class KamishibaiController : MonoBehaviour {
    ...
    public void act(Person actor, string serif, string position) {
        ...
        if (position == "left") NewImage.flipX = true;
        NewImage.GetComponent<RectTransform>().anchorMax = new Vector2(1f, 0.5f);
        NewImage.GetComponent<RectTransform>().anchorMin = new Vector2(1f, 0.5f);
