...
namespace Timeline {
    ...
    public class TimelineHelper {
        private void setRectPosition (RectTransform target, int left, int top, int right, int bottom) {
    ...
    public class Balloon : AbsCommand {
        ...
        public Balloon (string serif, string position) {
            ...
            if (position == "right") {
                // serifTrans.offsetMin = new Vector2(80f, 0f);
                ...
                balloonUITrans.anchorMin = new Vector2(0.5f, 0f);
                balloonUITrans.anchorMax = new Vector2(0.5f, 0f);
                balloonImage.sprite = Resources.Load<Sprite>(jibunBalloon);
            } else if (position == "left") {
                TimelineHelper.setRectPosition(serifTrans, 60, 10, 30, 20);
                serifTrans.offsetMin = new Vector2(300f, 0f);
                serifTrans.offsetMax = new Vector2(-80f, 0f);
                // balloonUITrans.offsetMin = new Vector2(-80f, -20f);
                // balloonUITrans.offsetMax = new Vector2(30f, 25f);
