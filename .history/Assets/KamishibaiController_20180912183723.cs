...
public class KamishibaiController : MonoBehaviour {
    ...
    public void action(Person actor, string serif, string position) {
        ...
        // chatviewにセリフを表示C
        balloon.transform.SetParent(GameObject.Find("/Canvas/ChatView/Viewport/Content").transform); //Assign the newly created Image GameObject as a Child of the Parent Panel.
        ...
        StartCoroutine(ScrollToBottom(content));
    }
