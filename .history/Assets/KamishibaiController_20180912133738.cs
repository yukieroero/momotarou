...
public class KamishibaiController : MonoBehaviour {
    ...
    public void act(Person actor, string serif, string position) {
        ...
        Debug.Log(Actor.Actor.transform);
        balloon.transform.SetParent(Actor.Actor.transform); //Assign the newly created Image GameObject as a Child of the Parent Panel.
