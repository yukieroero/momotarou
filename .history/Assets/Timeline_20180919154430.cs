...
namespace Timeline {
    ...
    public class Narrator {
        ...
        public void set(string text) {
            this.NarrationText.GetComponent<Text>().text = text;
    ...
    public class Balloon : AbsCommand {
        ...
        public Balloon (Person actor, string serif, string position) {
            ...
            if (position == "right") {
                ...
                balloonImage.sprite = Resources.Load<Sprite>("parts/balloon/" + actor.GetIdentifier() + "/right");
                ...
                balloonImage.sprite = Resources.Load<Sprite>("parts/balloon/" + actor.GetIdentifier() + "/left");
            }
    ...
    public class Person : AbsCommand {
        ...
        public Sprite getBalloonImg(string suffix = "") {
            string path = "parts/balloon/" + this.GetIdentifier();
            if (suffix != "") {
