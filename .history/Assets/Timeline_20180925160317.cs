...
namespace Timeline {
    ...
    public class TimelineHelper {
        public static void ChangeColor (Color current, float r=float.NaN, float g=float.NaN, float b=float.NaN, float a=float.NaN) {
    ...
    public class Narrator {
        ...
        public Narrator() {
            ...
            narration.AddComponent<NarratorContoller>();
    ...
    public class Person : AbsCommand {
        ...
        public void backFromWing(string position) {
            if (position == "right") this.move(x: -200f / 5, y: 10);
            else if (position == "left") this.move(x: 200f / 5, y: 10);
            this.atWing = false;
        }
