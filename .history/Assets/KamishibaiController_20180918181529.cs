...
public class KamishibaiController : MonoBehaviour {
    ...
    public void setNarration (string text) {
        narration.transform.Find("Text").GetComponent<Text>().text = text;
        narration.SetActive(true);
    }
    public void hideNarration () {
        narration.SetActive(false);
        narration.transform.Find("Text").GetComponent<Text>().text = "";
    }
    // タイトルの表示
    ...
    void Start () {
        ...
        narration = GameObject.Find("/Canvas/Narration");
