...
namespace Timeline {
    ...
    public class Narrator {
        GameObject canvas;
        Text narrationText;
        public Narrator(GameObject canvas) {
            this.canvas = canvas;
            GameObject narration = new GameObject();
            RectTransform narrationRect = narration.GetComponent<RectTransform>();
            ...
            narrationText = narration.AddComponent<Text>();
            TimelineHelper.setTextStyle(narrationText, 30, Color.white, Resources.Load<Font>("fonts/hiragino"));
        }
