...
public class KamishibaiController : MonoBehaviour {
    ...
    public void action(Person actor, string serif, string position) {
        ...
        balloon.balloon.transform.SetParent(chatview.transform); //Assign the newly created Image GameObject as a Child of the Parent Panel.
        balloon.balloon.SetActive(true);
        balloon.balloon.transform.localScale = new Vector3(1f, 1f, 1f);
