...
public class KamishibaiController : MonoBehaviour {
    ...
    public void action(Person actor, string serif, string position) {
        ...
        RectTransform balloonUIRect = balloon.GameObject.transform.Find("balloonUI").GetComponent<RectTransform>();
        ContentSizeFitter balloonUIFitter = balloon.GameObject.transform.Find("balloonUI").GetComponent<ContentSizeFitter>();
        float maxWidth = 400f;
